...
- Writing a memoir or personal narrative
...
- the user is a student in Burkina Faso, so the content should be relevant to the user's context
- the user is writing a memoir, so the content should be personal and reflective